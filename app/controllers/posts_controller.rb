class PostsController < ApplicationController
  ...
  private
    ...
    def post_params
      params.require(:post).permit(:title, :url, :image, :affiliate, :description, :duration, :tag_list, :video, :featured, :category, :featuredone, :featuredtwo, :categorytwo, :categorythree, :categoryfour, :category_ids => [])
    end
end
